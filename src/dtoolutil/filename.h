...
protected:
  ...
  static std::atomic<Filename *> _home_directory;
  static std::atomic<Filename *> _temp_directory;
  static std::atomic<Filename *> _user_appdata_directory;
  static std::atomic<Filename *> _common_appdata_directory;
};
