...
EXPCL_DTOOL_DTOOLUTIL int extract_words(const std::wstring &str, std::vector<std::wstring> &words);
...
EXPCL_DTOOL_DTOOLUTIL void tokenize(const std::wstring &str, std::vector<std::wstring> &words,
